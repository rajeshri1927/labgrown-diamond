                  ...
                  <div class="row">
                     <div class="col-md-6 border-right">
                        ...
                        <form class="form-signup" action="" method="post" name="form">
                           ...
                           <p>
                              Our Marketing executive will send you proposal and after approval will send you password within 24 working hours or contact Us 
                              In meantime you can sign in as direct customer and view all design and prices.
                           </p>
                           <button type="submit" class="btn-signup">Register / Sign Up</button>
                        </form>
                     </div>
