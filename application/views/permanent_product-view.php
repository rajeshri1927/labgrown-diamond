...
<div class="container-fluid">
   ...
   <!-- <h5 class="bread_head d-md-block d-sm-none d-none">No Catalogue Page Filters Selections.......</h5> -->
   ...
   <!-- <hr> -->
    <?php
      ...
      if (isset($api_response['response']['body']['diamonds']) && !empty($api_response['response']['body']['diamonds'])) {
        ...
        foreach ($api_response['response']['body']['diamonds'] as $index => $diamond) {
            $c++;			
			//echo "<br/>".$c ."||".$permanantproduct_order."<br/>";
		    if($c==$permanantproduct_order){
    ...
    <div class="diamond_part">
      <div class="row product_height">
        ...
        <div class="col-md-8">
		  <?php //print_r($permanent_product_page_details);?>
          <h1 class="diamond_head"><?php echo $permanent_product_page_details['permanent_product_page_title'] //echo $diamond['shape'].' '. $diamond['size'] .' ct '.' ' .$diamond['color'].'  ' .$diamond['clarity'];?>
          </h1>
