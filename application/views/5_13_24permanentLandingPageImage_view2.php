...
foreach($LandingPageBlocks as $block){
	   ...
	   $blocktitle = $block['permanent_landing_page_block_title'];
	 ...
	 if($block['permanent_landing_page_block_root']== "0"){  
	    //echo "<div   style='width:100%;border:1px solid #000;margin: 10px 0px;'>"; 
?>		
  <div class="langing_header">
   <?php echo "<".$blockTitleType.">Main block :".$block['permanent_landing_page_block_root']."//".$block['permanent_landing_page_block_title']."||".$block['permanent_landing_page_block_max_products']."</".$blockTitleType.">" ;?>
 ...
 if(isset($landingPage_block_data) && !empty($landingPage_block_data)){
	...
	foreach($landingPage_block_data as $landingPage_block ){	
	 ...
	 foreach($landingPage_block['response']['body']['diamonds'] as $diamond){ 
	  ...
	  if($Productnum < $block['permanent_landing_page_block_max_products'])
	  {
			$Productnum++;
?>   
    <div class="row">
...
<?php     
 foreach($LandingPageBlocks as $subblock){
	   ...
	   $subblocktitle = $subblock['permanent_landing_page_block_title'];
	...
	if($subblock['permanent_landing_page_block_root'] == $blockTitleType){
?>		
    <div class="langing_header">
      <?php  echo "<".$subblockTitleType.">Sub Block : ".$subblock['permanent_landing_page_block_title']."||".$subblock['permanent_landing_page_block_max_products']."</".$blockTitleType.">" ?>
     <div class="landing_border"></div>
    </div>
