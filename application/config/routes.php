...
$route['admin/b2bMarkup']       = 'Admin/b2bMarkup';
$route['get-b2bmarkup-form-view'] = 'B2BMarkup/get_b2bmarkup_form_view';
$route['set_b2bmarkup']           = 'B2BMarkup/set_b2bmarkup';
$route['get-b2bMarkups']         = 'B2BMarkup/get_b2bMarkups';

// tax

$route['admin/tax']       = 'Admin/tax';
$route['get-tax-form-view'] = 'Tax/get_tax_form_view';
$route['set_tax']           = 'Tax/set_tax';
$route['get-tax']         = 'Tax/get_tax';

// CountryGrp

$route['admin/countryGrp-markup-discont']       = 'Admin/tax';
...
$route['admin/jewellary-celebrities']     = 'JewCelebrity/jewellary_celebrities_view';
$route['set-jewellary-celebrity']         = 'JewCelebrity/set_jewellary_celebrity';
$route['get-jewellary-celebrities']       = 'JewCelebrity/get_jewellary_celebrities';
$route['get-jewellary-celebrity']         = 'JewCelebrity/get_jewellary_celebrity';
$route['delete-jewellary-celebrity']      = 'JewCelebrity/delete_jewellary_celebrity';
...
$route['delete-metal-plating']     = 'JewMetalPlating/delete_metal_plating';