...
//     $this->setTransactionAmount(50);
//     $this->setReturnUrl("http://vibhanatural.com/vibha-dev/atom-payment-response");
//     $this->setClientCode(123);
//     $this->setTransactionId($transactionId);
//     $this->setTransactionDate($transactionDate);
//     $this->setCustomerName("Test Name");
//     $this->setCustomerEmailId("test@test.com");
//     $this->setCustomerMobile("9999999999");
//     $this->setCustomerBillingAddress("Mumbai");
