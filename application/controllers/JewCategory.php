...
class JewCategory extends CI_Controller {
	...
	public function jewellary_categories_view() {
		$admin_session	= $this->session->userdata('admin');
		if(isset($admin_session) && !empty($admin_session)) {
			if($admin_session['isLoggedIn']){
				$data['view'] 				= 'admin/jewellary/category/category';
				$data['title'] 				= 'Lab Grown Diamond | Category';
				$data['script']				= 'jewellary/category.js';
	...
	public function set_jewellary_category() {
	...
	public function get_jewellary_categories(){
		$postData = $this->input->post();
     	$data = $this->category_model->get_categories($postData);
     	echo json_encode($data);
	}

	public function get_jewellary_category(){
		$response 	= array();
	...
	public function delete_jewellary_category(){
		$postData 	= $this->input->post();
		$response 	= array();
