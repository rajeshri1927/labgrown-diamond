...
/*************** **************************
     permanent product page - gen
*************** ****************/	 

   public function permanent_product_page(){

	print_r('jbdjjbdjkbjkdb jbjdbjk  j je jc j ejk k  j');die;
	   $last  = $this->uri->total_segments();
	   $pageAtr = $this->uri->segment($last);
	   //echo "Arg-".$pageAtr;
       $pageAtr_ary = explode("-",$pageAtr);
       //print_r($pageAtr_ary);	   
	   $permanent_product_page_id = $pageAtr_ary[0];
	   $permanent_product_page_order = $pageAtr_ary[1];
	   //echo "<br/>permanent_product_page_id :". $permanent_product_page_id ."|| permanent_product_page_order :".$permanent_product_page_order;
	   
	   $result =  $this->product_model->getPermanentProductPageDetails($permanent_product_page_id);
 ...
 //**************************************************************************  
	   $input_details 	= $this->input->post();
		...
		$api_url = 'https://apiservices.vdbapp.com/v2/diamonds?type=Lab_grown_Diamond&';
		//echo "<br/><br/>";
       // print_r($result['permanent_product_page_filter1_lbl']);		
		//echo "<br/>";
	//	for($k=9; $k<=18;$k++){
		 if($result['permanent_product_page_filter1_lbl']=="size_from")
			$api_url .= '&size_from=' . urlencode($result['permanent_product_page_filter1']) .'&size_to='. urlencode($result['permanent_product_page_filter2']);
		  
		 
		
		if($result['permanent_product_page_filter3_lbl']!="")
			$api_url .= '&'.$result['permanent_product_page_filter3_lbl'].'=' . ucfirst($result['permanent_product_page_filter3']) ;
		
		
		if($result['permanent_product_page_filter4_lbl']!="")
			$api_url .= '&'.$result['permanent_product_page_filter4_lbl'].'=' . ucfirst($result['permanent_product_page_filter4']) ;
		
		
		if($result['permanent_product_page_filter5_lbl']!="")
			$api_url .= '&'.$result['permanent_product_page_filter5_lbl'].'=' . ucfirst($result['permanent_product_page_filter5']) ;
		
		if($result['permanent_product_page_filter6_lbl']!="")
			$api_url .= '&'.$result['permanent_product_page_filter6_lbl'].'=' . ucfirst($result['permanent_product_page_filter6']) ;
  ...
  /****		
		...
		***/
		...
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => $result['permanent_product_page_limit'],
		CURLOPT_TIMEOUT => 0,
		CURLOPT_FOLLOWLOCATION => true,
		CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
		CURLOPT_CUSTOMREQUEST => 'GET',
		...
		if($user_session){
			...
			if (isset($data['json_data']['response']['body']['diamonds']) && !empty($data['json_data']['response']['body']['diamonds'])) {
		        ...
		        $data['permanantproduct_order'] = $permanent_product_page_order ;
				$data['permanent_product_page_details'] = $result;
				//print_r($data['permanent_product_page_details']);
		        $data['api_response']       = $api_response;
				$data['view']               = 'permanent_product-view';
				$data['show_top_navbar']    = true;
				$data['link']               = 'product';
				$data['title']              = 'Lab Grown Diamond | Product View';
				$data['quality']            = $this->quality_model->get_quality();
...
/********************************** Upload city page ****************************************** */
 ...
 public function upload_permanent_product_page_excel(){
	   //echo "<h2>Testtttt.....</h2>";
		$config['upload_path']   = './assets/uploads/permanent_product_page_excel/';
        $config['allowed_types'] = 'csv';
        $config['max_size']      = 1024; // 1MB max size
        ...
        if ($this->upload->do_upload('product_upload_excel')){
		   ...
		   // Parse CSV file
			...
			//$response 	= array('state'=>TRUE,'title'=>'','type'=>'success','message'=>'product Data uploaded successfully!' ); 
 ...
 public function get_permanent_product_page_details(){
	
	    $permanent_product_page_id = 	$this->uri->segment(2);
		//echo "permanent_product_page...:".$permanent_product_page_id."<br/>";
		$permanent_product_page_detail = $this->product_model->get_permanent_product_page_detail($permanent_product_page_id);
		//print_r($permanent_product_page_detail);
		echo "<table border=1>";
		//foreach($permanent_product_page_detail as $product_page_detail){
		   echo "<tr>";
			   echo "<td>permanent page tpl</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_tpl']."</td>";
			echo "</tr><tr>";   
			   echo "<td>permanent page metatitle</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_metatitle']."</td>";
			echo "</tr><tr>";   
			   echo "<td>Permanent Page metadetails</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_metadetails']."</td>";
			echo "</tr><tr>";   
			   echo "<td>Permanent Page keyword</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_keyword']."</td>";
			echo "</tr><tr>";
			   echo "<td>Permanent page category</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_category']."</td>";
			echo "</tr><tr>";
			   echo "<td>Permanent page img_alt</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_img_alt']."</td>";
			echo "</tr><tr>";
			   echo "<td>permanent page title</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_title']."</td>";
			echo "</tr><tr>";
			    echo "<td colspan='2'>Filters</td>";
			echo "</tr>";
			if($permanent_product_page_detail[0]['permanent_product_page_filter1_lbl']!=""){ 
			 echo "<tr>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter1_lbl']."</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter1']."</td>";
			echo "</tr> ";
            }
			if($permanent_product_page_detail[0]['permanent_product_page_filter2_lbl']!=""){ 			 
			echo "<tr>"; 
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter2_lbl']."</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter2']."</td>";
			echo "</tr>";
		    }
			if($permanent_product_page_detail[0]['permanent_product_page_filter3_lbl']!=""){ 	
			echo "<tr>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter3_lbl']."</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter3']."</td>";
			echo "</tr>" ;
			}
			if($permanent_product_page_detail[0]['permanent_product_page_filter4_lbl']!=""){ 	
			echo "<tr>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter4_lbl']."</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter4']."</td>";
			echo "</tr>";
		    }
			if($permanent_product_page_detail[0]['permanent_product_page_filter5_lbl']!=""){ 	
            echo "<tr>"; 			 
			 echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter5_lbl']."</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter5']."</td>";
			echo "</tr>";
			}
			if($permanent_product_page_detail[0]['permanent_product_page_filter6_lbl']!=""){ 
			echo "<tr>"; 
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter6_lbl']."</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_filter6']."</td>";
			echo "</tr>";
            }	
            echo "<tr>"; 
			   echo "<td>Permanent Product Page Limit</td>";
			   echo "<td>".$permanent_product_page_detail[0]['permanent_product_page_limit']."</td>";
			echo "</tr>";			
             echo "<tr>";
			    echo "<td colspan='2'>Urls</td>";
			 echo "</tr>";
             for($i=1;$i<=$permanent_product_page_detail[0]['permanent_product_page_limit'];$i++){
				 $href = base_url().$permanent_product_page_detail[0]['permanent_product_page_url']."/".$permanent_product_page_detail[0]['permanent_product_page_Id']."-".sprintf('%03d',$i);
				 echo "<tr>";
			        echo "<td>url - ".$i."</td>";
