...
document.addEventListener("DOMContentLoaded", function() {
  var shareIcons = document.querySelectorAll('.fa-share-alt');
  var catelogueShares = document.querySelectorAll('.catelogue_share');

  shareIcons.forEach(function(shareIcon, index) {
    var catelogueShare = catelogueShares[index];

    shareIcon.addEventListener("mouseenter", function() {
      catelogueShare.style.opacity = "1";
      catelogueShare.style.visibility = "visible";
    });

    catelogueShare.addEventListener("mouseleave", function() {
      catelogueShare.style.opacity = "0";
      catelogueShare.style.visibility = "hidden";
    });
  });
});
...
$("#topfun").click(function () {
 ...
 //main menu  
      $(document).ready(function(){ 
      var touch     = $('#resp-menu_1');
      var close   = $('#close_menu1');
      var menu  = $('.menu_1');
