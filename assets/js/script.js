...
$(document).ready(function(){
    $('#sort').click(function(event){
        event.stopPropagation();
         $("#sorting_landing").slideToggle("slow");
    });
    $("#sorting_landing").on("click", function (event) {
        event.stopPropagation();
    });
});

$(document).on("click", function () {
    $("#sorting_landing").hide();
});

$(document).ready(function(){
  $('#sort').click(function(event){
      event.stopPropagation();
      $("#input_range").css('display', function(_, currentDisplay){
