(($) => {
	...
	function getProducts(){
		...
		let product_list_table = document.getElementById('product-list'); 
		let endpoint = 'get_permanent_landing_page_list';
    	let formdata = {};
    	let tbl_body = '';
    	...
    	$.Utility.getData(endpoint, formdata, (response) => {
    		...
    		if(response.state){
    			response.data.forEach((element)=>{
    				tbl_body += `
    					<tr>
    					    <td>  ${element.permanent_landing_page_id}</td>
							<td>
								<strong>${element.permanent_landing_page_url}</strong></td>
							<td class="text-center"> ${element.permanent_landing_page_metatitle}</td>; 
							<td class="text-center"> ${element.permanent_landing_page_metadetails}</td>; 
							<td class="text-center">${element.permanent_landing_page_keyword}</td>
							<td class="text-center">${element.permanent_landing_page_category}   </td>
							
							<td class="text-center">
							    <a href='get_permanent_landing_page_blocks/${element.permanent_landing_page_id}' class="" target=_blank > Bloks </a> 
	...
	function uploadProductExcel(){
		alert("Lnding - Hiiiiiii");
		let endpoint = 'upload-Permanent-landing-Page-excel';
		...
		bootbox.confirm({
			title: "Upload Permanent landing Page Excel",
