$(document).ready(function(){
    ...
    function getSubCategoryFrom(sub_category_id = null){
    	let endpoint = 'get-b2bmarkup-form-view';
    	let formdata = {
    	...
    	$.Utility.getData(endpoint, formdata, (response) => {
    		...
    		if(response.state){
    			response.data.forEach((element)=>{
    				tbl_body += `
    					<tr>
							<td class="text-center">${element.b2b_ctry_priceRange_class_markup_id}</td>
							<td class="text-center">India</td>
							<td class="text-center">${element.price_range}</td>
							<td class="text-center">${element.b2b_ctry_priceRange_class_markup_starClass}</td>
							<td class="text-center">${element.b2b_ctry_priceRange_class_markup_markup}</td>
